# Github repo to learn Cache utilization of the Employees DB. 

1. it is a public repo
2. usage is limited to Oracle DB. Can be configured to Mysql OR H2 DB in application Configurations.
